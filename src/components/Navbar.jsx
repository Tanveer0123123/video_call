        ...
        <header className="pb-6 bg-white lg:pb-0" x-data="{expanded: false}">
            ...
            {/* <nav x-show="expanded" className="pt-4 pb-6 bg-white border border-gray-200 rounded-md shadow-md lg:hidden">
                ...
                <div className="px-6 mt-6">
                    <a href="#" title="" className="inline-flex justify-center px-4 py-3 text-base font-semibold text-white transition-all duration-200 bg-blue-600 border border-transparent rounded-md items-center hover:bg-blue-700 focus:bg-blue-700" role="button"> Get started </a>
                </div>
            </nav> */}
        </div>
</header >
